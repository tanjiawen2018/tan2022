...
<xsl:stylesheet version="1.0"
                ...
                xmlns:msfunction="http://www.mycompany.org/ns/function" exclude-result-prefixes="msxsl msfunction">





<xsl:param name="titleReport" select="'API_test_report'"/>
	...
	<xsl:template name="pageHeader">
        ...
        function clock(){
            ...
            var now =  year + "/" + month + "/" + day + " " + hours + ":" + min + ":" + sec;
            return now.toString();
        }
    ]]></script>
		<table width="100%">
			<tr>
				...
				<td align="right" class="data">Date report:
					<xsl:value-of select="$dateReport"/><!--Designed for use with <a href="http://jmeter.apache.org/">JMeter</a> and <a href="http://ant.apache.org">Ant</a>.-->
				</td>
			</tr>
		</table>
		<hr size="1"/>
